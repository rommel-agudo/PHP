...
require_once 'framework/MySQLDB.php';
	...
	try {
		...
		$db->execute( "insert into business values (null,'business1','City Fitbit','business1','hush@gmail.com',false )") ;
		$db->execute( "insert into business values (null,'business2','Moorhouse Gang','business2','jordan@gmail.com',false)" ) ;
		$db->execute( "insert into business values (null,'business3','Tekapo Thingz','business3','alex@gmail.com',false)" ) ;
		...
		$db->execute( "insert into products values (1,'book','handy dandy book', 10.55)") ;
		$db->execute( "insert into products values (2,'diary','record everthing with this', 5.55)") ;
		$db->execute( "insert into products values (3,'pen','of course you need a pen', 2.55)") ;
