...
class MasterPage {
	...
	private function getLoginPanel() {
		...
		$html='<span class="login">Logged in as <em>'.$this->business->getBusinessName().'</em>';
		if ($this->business->getIsAdmin()==true){
			$html.=' (administrator)';
		}

		$html .= '<li><a href="products.php">Products</a></li>';
		$html .= '<li><a href="deleteBuyerSeller.php">Delete Buyer/Seller</a></li>';
